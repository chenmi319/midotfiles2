# Generated by Powerlevel10k configuration wizard on 2024-02-16 at 22:16 CST.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    ...
    # toolbox               # toolbox name (https://github.com/containers/toolbox) — Fedora only
  ...
  typeset -g POWERLEVEL9K_RULER_CHAR='─'        # reasonable alternative: 'y'
